...
class MoleculeConfig(BaseConfig):
    ...
    def __init__(self):
        ...
        seed = 42
        self.evaluation_scaffolds_path = f"scaffold_splitting/zinc_splits_optimized/run_seed_{seed}/test_scaffolds_small.txt"  # test scaffolds
        self.validation_scaffolds_path = f"scaffold_splitting/zinc_splits_optimized/run_seed_{seed}/val_scaffolds_small.txt"
