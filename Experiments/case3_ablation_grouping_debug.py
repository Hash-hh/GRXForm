...
class MoleculeConfig(BaseConfig):
    ...
    def __init__(self):
        ...
        seed = 42
        self.fragment_library_path = f"scaffold_splitting/zinc_splits_optimized/run_seed_{seed}/train_scaffolds.txt"  # Ignored
        self.evaluation_scaffolds_path = f"scaffold_splitting/zinc_splits_optimized/run_seed_{seed}/test_scaffolds_lil.txt"  # test scaffolds
